...
const translations: Record<string, Record<Locale, string>> = {
  ...
  "cat.music": { en: "Music", sw: "Muziki" },
  "cat.comedy": { en: "Comedy", sw: "Vichekesho" },
  "cat.education": { en: "Education", sw: "Elimu" },
  "cat.sports": { en: "Sports", sw: "Michezo" },
  "cat.lifestyle": { en: "Lifestyle", sw: "Maisha" },
  "cat.tech": { en: "Technology", sw: "Teknolojia" },
  "cat.exclusive": { en: "🔥 Exclusive", sw: "🔥 Maalum" },
